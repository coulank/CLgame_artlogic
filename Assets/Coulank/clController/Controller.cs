...
namespace clController
{
        ...
        public static ConTempSet SysTemplate = new ConTempSet()
    {
        ...
        new ConTemplate(KeyType.KeyAxis, ButtonType.CTRL, 0, "ctrl"),
        new ConTemplate(KeyType.KeyAxis, ButtonType.ALT, 0, "alt"),
        new ConTemplate(KeyType.KeyAxis, ButtonType.SHIFT, 0, "shift"),
        new ConTemplate(KeyType.KeyAxis, ButtonType.CMD, 0, "cmd"),
